...
namespace QuanLiKhachSan.Views
{
    public partial class fr_ThuePhong : Form
    {
        ...
        {
            string query = "SELECT TenKhachHang,MaPhong,NgayThue,ThoiGian FROM dbo.ThuePhong,dbo.KhachHang WHERE KhachHang.MaKhachHang=ThuePhong.MaKhachHang";
        ...
        {
            List<cbPhong> listPhong = cbPhongDAO.Instance.LayDSThuePhong();
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            {
                if (ThuePhong.Instance.ThemThuePhong(maKH,maPhong,ngayThue,thoiGianO) == true)
                {
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            DateTime ngayThue = dtpNgayThue.Value;
            int thoiGianO = Convert.ToInt32(txtThoiGianO.Text);
            if (ThuePhong.Instance.SuaThuePhong(maKH, maPhong, ngayThue, thoiGianO) == true)
            {
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            string maPhong = (cbMaPhong.SelectedItem as cbPhong).MaPhong;
            string maKH = (cbTenKH.SelectedItem as cbKhachHang).MaKH;
            if (ThuePhong.Instance.XoaThuePhong(maKH,maPhong) == true)
            {
        ...
        private void dgvThuePhong_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                cbTenKH.Text = Convert.ToString(dgvThuePhong.CurrentRow.Cells["tenKH"].Value);
                ...
                txtThoiGianO.Text = Convert.ToString(dgvThuePhong.CurrentRow.Cells["thoiGian"].Value);
            }
        }
